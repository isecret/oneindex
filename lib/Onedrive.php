<?php
    class Onedrive
    {
        ...
        public static $api_url = 'https://graph.microsoft.com/v1.0';
        public static $oauth_url = 'https://login.microsoftonline.com/common/oauth2/v2.0';
        ...
        public static function dir($path="/")
        {
            ...
            if (is_array($hide_list) && count($hide_list)>0 && array_filter($hide_list)) {
                foreach ($hide_list as $hide_dir) {
                    foreach ($items as $key=>$_array) {
                        if (stristr($key, trim($hide_dir))) {
                            unset($items[$key]);
                        }
                    }
                }
